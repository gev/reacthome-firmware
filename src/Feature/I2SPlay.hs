...
mkI2SPlay :: (MonadState Context m, Handler HandleI2STX i, KnownNat n) => String -> i -> m (I2SPlay n)
...
transmitI2S :: KnownNat n => I2SPlay n -> Ivory eff Sample
...
playI2S :: KnownNat n => I2SPlay n -> (Sample -> Ivory eff ()) -> Ivory eff ()
