...
pack_uint16 :: KnownNat n => Def ('[Ref s (Array n (Stored Uint8)), Ix n, Uint16] :-> ())
pack_uint16 = importProc "pack_uint16" "serialize.h"

unpack_uint16 :: KnownNat n => Def ('[Ref s (Array n (Stored Uint8)), Ix n] :-> Uint16)
unpack_uint16 = importProc "unpack_uint16" "serialize.h"


pack_sint16 :: KnownNat n => Def ('[Ref s (Array n (Stored Uint8)), Ix n, Sint16] :-> ())
pack_sint16 = importProc "pack_sint16" "serialize.h"

unpack_sint16 :: KnownNat n => Def ('[Ref s (Array n (Stored Uint8)), Ix n] :-> Sint16)
unpack_sint16 = importProc "unpack_sint16" "serialize.h"


pack_uint32 :: KnownNat n => Def ('[Ref s (Array n (Stored Uint8)), Ix n, Uint32] :-> ())
pack_uint32 = importProc "pack_uint32" "serialize.h"

unpack_uint32 :: KnownNat n => Def ('[Ref s (Array n (Stored Uint8)), Ix n] :-> Uint32)
unpack_uint32 = importProc "unpack_uint32" "serialize.h"


pack_sint32 :: KnownNat n => Def ('[Ref s (Array n (Stored Uint8)), Ix n, Sint32] :-> ())
pack_sint32 = importProc "pack_sint32" "serialize.h"

unpack_sint32 :: KnownNat n => Def ('[Ref s (Array n (Stored Uint8)), Ix n] :-> Sint32)
