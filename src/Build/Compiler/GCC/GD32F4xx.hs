  ...
  mkCompiler MCUmod{..} =
    ...
    GCC { defs    = [ "-D" <> (toUpper <$> model)
        ...
        , incs    = [ "-Isupport/inc"
                    ...
                    ,"-Isupport/lwip-2.1.2/src/include/compat"
                    ...
                    ,"-Isupport/lwip-2.1.2/src/include/compat/posix/sys"
                    ,"-Isupport/lwip-2.1.2/src/include/compat/stdc"
                    ,"-Isupport/lwip-2.1.2/src/include/lwip"
                    ,"-Isupport/lwip-2.1.2/src/include/lwip/prot"
                    ,"-Isupport/lwip-2.1.2/src/include/lwip/priv"
