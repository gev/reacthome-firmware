...
selectDmaBuff :: KnownNat n => DoubleBuffer n t -> (Buffer n t -> Ivory (ProcEffects s ()) ()) -> Ivory (ProcEffects s ()) ()
...
selectHandlerBuff :: KnownNat n => DoubleBuffer n t -> (Buffer n t -> Ivory (ProcEffects s ()) ()) -> Ivory (ProcEffects s ()) ()
